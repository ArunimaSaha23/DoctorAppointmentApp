...
const Doctors = () => {
  ...
  const applyFilter = () => {
    if (!speciality) {
      // If no speciality param, show all doctors
      setFilterDoc(doctors);
    } else {
      // Filter based on the speciality
      const filteredDoctors = doctors.filter(doc => doc.speciality.toLowerCase() === speciality.toLowerCase());
